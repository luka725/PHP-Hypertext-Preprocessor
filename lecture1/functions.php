...
function student_Massive_Filter($array){
    ...
    elseif($array['grade'] >= 93 && $array['grade'] <= 96):
        $filtered_array['grade'] = "A";
    elseif($array['grade'] >= 90 && $array['grade'] <= 92):
        $filtered_array['grade'] = "A-";
    elseif($array['grade'] >= 87 && $array['grade'] <= 89):
        $filtered_array['grade'] = "B+";
    elseif($array['grade'] >= 83 && $array['grade'] <= 86):
        $filtered_array['grade'] = "B";
    elseif($array['grade'] >= 80 && $array['grade'] <= 82):
        $filtered_array['grade'] = "B-";
    elseif($array['grade'] >= 77 && $array['grade'] <= 79):
        $filtered_array['grade'] = "C+";
    elseif($array['grade'] >= 73 && $array['grade'] <= 76):
        $filtered_array['grade'] = "C";
    elseif($array['grade'] >= 70 && $array['grade'] <= 82):
        $filtered_array['grade'] = "C-";
    elseif($array['grade'] >= 67 && $array['grade'] <= 69):
        $filtered_array['grade'] = "D+";
    elseif($array['grade'] >= 63 && $array['grade'] <= 66):
        $filtered_array['grade'] = "D";
    elseif($array['grade'] >= 60 && $array['grade'] <= 62):
        $filtered_array['grade'] = "D-";
    elseif($array['grade'] >= 0 && $array['grade'] <= 59):
